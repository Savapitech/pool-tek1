...
void my_strcapitalize2(char *, char *);
void my_str_to_word_a_print(char const *, int, int *, char **);
int my_check_number_of_words(char const *);
int my_str_to_word_array_len(int *len_a, int *, char const *, int);
int is_alpha_num(char const);
